...
different situations.
    ...
    If the user wishes to build models their own models using this pipline, they will start by running: python fetch_prune/fetch_all_flight.py --start YYYY/MM --end YYYY/MM
...
more accurate by fitting on an external set of data.
